...
test('editor interaction module exposes a key-stream runner', () => {
  ...
  assert.match(renderSource, /CALL\s+EditorRenderPageBuffer/);
  ...
  assert.match(renderSource, /@EditorKeyRenderDirty:[\s\S]*?CALL\s+EditorEnsureCursorVisible[\s\S]*?CALL\s+EditorRenderPageBuffer/);

...
test('editor interaction module exposes a key-stream runner', () => {
  ...
  assert.match(source, /EditorModifiedCommandFromKey:[\s\S]*?AND\s+TECM8_EDITOR_KEY_MOD_CTRL/);
  assert.match(source, /CP\s+"s"\n\s+JR\s+Z,EditorModifiedCommandSave/);
  assert.match(source, /CP\s+"S"\n\s+JR\s+Z,EditorModifiedCommandSave/);
  assert.doesNotMatch(source, /EditorModifiedCommandAltQuit/);
  assert.match(source, /CP\s+"c"\n\s+JR\s+Z,EditorModifiedCommandCopy/);
  assert.match(source, /CP\s+"C"\n\s+JR\s+Z,EditorModifiedCommandCopy/);
  ...
  assert.match(source, /EditorModifiedCommandControlByteCopy:\n\s+LD\s+A,\(BiosInputRawPrimary\)\n\s+CP\s+TECM8_EDITOR_KEY_ARROW_UP\n\s+JR\s+Z,EditorModifiedCommandNone\n\s+JP\s+EditorModifiedCommandCopy/);
  assert.doesNotMatch(source, /EditorModifiedCommand(?:Save|Quit|Restore|Copy|Move|Paste|DeleteLine):[\s\S]*?TECM8_EDITOR_ACTION_(?:PAGE|CURSOR)_/);
  assert.doesNotMatch(source, /EditorModifiedCommand(?:Save|Quit|Restore|Copy|Move|Paste|DeleteLine):[\s\S]*?EditorAction(?:Page|Cursor)/);
  assert.doesNotMatch(source, /EditorModifiedCommand(?:Save|Quit|Restore|Copy|Move|Paste|DeleteLine):[\s\S]*?EditorKey(?:Page|Cursor)/);
  assert.match(source, /CP\s+TECM8_EDITOR_KEY_CTRL_X\n\s+JR\s+Z,EditorModifiedCommandMove/);
  assert.match(source, /CP\s+TECM8_EDITOR_KEY_CTRL_V\n\s+JR\s+Z,EditorModifiedCommandPaste/);
  assert.match(source, /CP\s+TECM8_EDITOR_KEY_CTRL_Y\n\s+JR\s+Z,EditorModifiedCommandDeleteLine/);
  ...
  assert.match(source, /CP\s+"Z"\n\s+JR\s+Z,EditorModifiedCommandRestore/);
  assert.doesNotMatch(source, /CP\s+"y"\n\s+JR\s+Z,EditorModifiedCommandDeleteLine/);
  assert.doesNotMatch(source, /CP\s+"Y"\n\s+JR\s+Z,EditorModifiedCommandDeleteLine/);
  assert.doesNotMatch(source, /CP\s+"r"\n\s+JR\s+Z,EditorModifiedCommandRestore/);
  assert.doesNotMatch(source, /CP\s+"R"\n\s+JR\s+Z,EditorModifiedCommandRestore/);
  ...
  assert.match(source, /@EditorShouldIgnoreModifiedPrintable:[\s\S]*?AND\s+TECM8_EDITOR_KEY_MOD_CTRL[\s\S]*?LD\s+A,1\n\s+OR\s+A\n\s+RET/);
